...
<code>
./dfwcopy.py --nsx NSX --user USER [--password PASSWORD] --file FILENAME --export
</code>
...
<code>
./dfwcopy.py --nsx NSX --user USER [--password PASSWORD] --file FILENAME [--output FILENAME] [--logfile LOGFILENAME]
...
<code>
./dfwcopy.py --nsx NSX --user USER [--password PASSWORD] --file FILENAME [--output FILENAME] [--logfile FILENAME] --prefix PREFIX
...
<code>
./dfwcopy.py --nsx NSX --user USER [--password PASSWORD] --file FILENAME [--output FILENAME] [--logfile LOGFILENAME] --prefix PREFIX --anchor NAME_OF_ANCHOR_POLICY [--position {insert_before | insert_after}]
</code>
